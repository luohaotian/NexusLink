...
public class FileController {
    ...
    public ResponseJson uploadDoc(@RequestParam("description") String description, MultipartFile file, HttpServletRequest request){
        final String fileLocation = request.getServletContext().getInitParameter("fileLocation");
        ...
        if(file!=null&&file.getSize()>0&&type!=null){
            ...
            try {
                System.out.println("上传文件中-------" + fileLocation +fileName );
